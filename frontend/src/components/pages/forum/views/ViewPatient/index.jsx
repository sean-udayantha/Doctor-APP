...
const ViewPatient = () => {
  ...
  const filteredPosts = patientList.filter((postsList) => {
    return (
      postsList.name.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
      postsList.age.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
      postsList.NIC.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
      postsList.address.toLowerCase().includes(searchTerm.toLocaleLowerCase()) ||
      postsList.mobileNumber.toLowerCase().includes(searchTerm.toLocaleLowerCase())
    );
  });
